...
const VERSES = [
  {
    ref: { fr: "Jérémie 29:11", ht: "Jeremi 29:11", en: "Jeremiah 29:11" },
    fr: "Car je connais les projets que j'ai formés sur vous — projets de paix et non de malheur, afin de vous donner un avenir et de l'espérance.",
    ht: "Paske mwen konnen plan mwen genyen pou nou — plan pou fè nou jwenn lapè, pa dezas, pou ba nou yon avni ak espwa.",
    en: "For I know the plans I have for you — plans to prosper you and not to harm you, plans to give you hope and a future.",
  },
  {
    ref: { fr: "Philippiens 4:13", ht: "Filipyen 4:13", en: "Philippians 4:13" },
    fr: "Je puis tout par celui qui me fortifie.",
    ht: "Mwen ka fè tout bagay nan Kris la ki ban mwen fòs.",
    en: "I can do all things through Christ who strengthens me.",
  },
  {
    ref: { fr: "Ésaïe 41:10", ht: "Ezayi 41:10", en: "Isaiah 41:10" },
    fr: "Ne crains rien, car je suis avec toi. Ne promène pas des regards inquiets, car je suis ton Dieu.",
    ht: "Pa pè, paske mwen avèk ou. Pa dekouraje, paske mwen se Bondye ou.",
    en: "Do not fear, for I am with you. Do not be dismayed, for I am your God.",
  },
  {
    ref: { fr: "Psaumes 23:1", ht: "Sòm 23:1", en: "Psalm 23:1" },
    fr: "L'Éternel est mon berger : je ne manquerai de rien.",
    ht: "Seyè a se gadò mwen — mwen p ap manke anyen.",
    en: "The Lord is my shepherd — I lack nothing.",
  },
  {
    ref: { fr: "Romains 8:28", ht: "Women 8:28", en: "Romans 8:28" },
  ...
  {
    ref: { fr: "2 Timothée 1:7", ht: "2 Timote 1:7", en: "2 Timothy 1:7" },
    fr: "Dieu ne nous a pas donné un esprit de timidité, mais un esprit de force, d'amour et de sagesse.",
    ht: "Bondye pa ba nou yon lespri pè, men yon lespri fòs, renmen ak disiplin.",
    en: "God has not given us a spirit of fear, but of power, love and sound mind.",
  },
  {
    ref: { fr: "Jean 14:6", ht: "Jan 14:6", en: "John 14:6" },
    fr: "Je suis le chemin, la vérité, et la vie. Nul ne vient au Père que par moi.",
    ht: "Mwen se chemen an, verite a, ak lavi a. Pesonn pa ka al jwenn Papa a si se pa pase nan mwen.",
...
export default function AujourduiPage() {
  ...
  const txt = {
    ...
    verseLabel:   { fr: "Verset du jour",        ht: "Vèsè jou a",         en: "Verse of the day" },
    studyMore:    { fr: "Approfondir l'étude",   ht: "Etidye plis",        en: "Study more" },
    prayVerse:    { fr: "Prier ce verset",       ht: "Priye vèsè sa",      en: "Pray this verse" },
    challenge:    { fr: "Défi biblique du jour", ht: "Defi biblik jou a",  en: "Biblical challenge" },
    reveal:       { fr: "Révéler la réponse",    ht: "Montre repons nan",  en: "Reveal answer" },
    correct:      { fr: "Bonne réponse !",       ht: "Bon repons !",       en: "Correct!" },
    moreChallenges: { fr: "Plus de défis →",     ht: "Plis defi →",        en: "More challenges →" },
    featuredContest: { fr: "Concours du moment", ht: "Konkou kounye a",    en: "Featured contest" },
    participants: { fr: "participants",           ht: "patisipan",          en: "participants" },
    watchLive:    { fr: "Regarder en direct →",  ht: "Gade an dirèk →",    en: "Watch live →" },
    register:     { fr: "S'inscrire →",          ht: "Enskri →",           en: "Register →" },
    ecosystem:    { fr: "Tout l'écosystème KONEKSYON PAM", ht: "Tout ekosistèm KONEKSYON PAM", en: "The full KONEKSYON PAM ecosystem" },
    dashTitle:    { fr: "Votre tableau de bord personnel", ht: "Tablo bò pèsonèl ou a",       en: "Your personal dashboard" },
    dashDesc:     { fr: "Niveau, badges, statistiques, concours en cours.", ht: "Nivo, baj, estatistik, konkou an kou.", en: "Level, badges, statistics, live contests." },
    dashBtn:      { fr: "Mon Dashboard →",       ht: "Dashboard mwen →",   en: "My Dashboard →" },
  };
    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-8 py-10 grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="md:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#0f2044] to-[#1a3a70] p-8">
          ...
          <p className="text-[#c5a84f] text-sm font-bold">{verse.ref[l]}</p>
        ...
        <div className="rounded-3xl bg-white border border-stone-100 p-6 shadow-sm">
          ...
          {!showAnswer ? (
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl px-5 py-4">
              ...
              <p className="text-green-600 text-xs mt-1">{t("correct")}</p>
            </div>
          )}
        ...
        {featuredContest && (
          <div className="rounded-3xl bg-white border border-stone-100 p-6 shadow-sm flex flex-col">
            ...
            <div className="flex items-start gap-3 flex-1">
              ...
              <div className="flex-1">
                ...
                <p className="text-stone-400 text-xs mt-1">
                  {featuredContest.contest_participants?.[0]?.count ?? 0} {t("participants")}
                </p>
              </div>
            </div>
            <Link href={`/concours/${featuredContest.id}`}
              ...
              {featuredContest.status === "active" ? t("watchLive") : t("register")}
            </Link>
          </div>
        )}
        ...
        <div className="md:col-span-2 rounded-3xl bg-gradient-to-r from-[#0f2044] to-[#1e3a6e] p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            <p className="text-white font-black text-lg">{t("dashTitle")}</p>
            <p className="text-white/40 text-sm mt-1">{t("dashDesc")}</p>
          </div>
          <Link href="/dashboard"
