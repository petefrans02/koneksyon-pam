...
const STATIC: MetadataRoute.Sitemap = [
  ...
  entry("/academie",     0.85, "weekly"),
  entry("/etude",        0.82, "weekly"),
  entry("/championnats", 0.82, "daily"),
  entry("/communaute",   0.80, "weekly"),
  entry("/anglais", "/quiz",         0.72, "weekly"),
  entry("/decouvrir",    0.65, "monthly"),
  entry("/psaumes",      0.65, "monthly"),
  entry("/louange",      0.65, "monthly"),
  entry("/mission",      0.85, "monthly"),
  entry("/impact",       0.80, "monthly"),
  entry("/projets",      0.75, "monthly"),
  entry("/fondation",    0.70, "monthly"),
