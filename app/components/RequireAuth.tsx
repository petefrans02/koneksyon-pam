    ...
    return (
      <div className="max-w-md mx-auto px-6 py-20 text-center">
        ...
        <button
          ...
          aria-label={lang === "fr" ? "Se connecter avec votre compte Google" : lang === "ht" ? "Konekte ak kont Google ou" : "Sign in with your Google account"}
        >
          ...
          {lang === "fr" ? "Continuer avec Google" : lang === "ht" ? "Kontinye ak Google" : "Continue with Google"}
        </button>
