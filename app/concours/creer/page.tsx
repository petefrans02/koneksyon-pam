          ...
          <section className="flex flex-col gap-5 rounded-2xl p-6" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)" }}>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {[
                  { v: "bible", label: l === "fr" ? "Toute la Bible" : l === "ht" ? "Tout Bib la" : l === "es" ? "Toda la Biblia" : "Whole Bible" },
                  { v: "ancien-testament", label: l === "fr" ? "Ancien Testament" : l === "ht" ? "Ansyen Testaman" : l === "es" ? "Antiguo Testamento" : "Old Testament" },
                  { v: "nouveau-testament", label: l === "fr" ? "Nouveau Testament" : l === "ht" ? "Nouvo Testaman" : l === "es" ? "Nuevo Testamento" : "New Testament" },
                  { v: "vie-jesus", label: l === "fr" ? "Vie de Jésus" : l === "ht" ? "Lavi Jezi" : l === "es" ? "Vida de Jesús" : "Life of Jesus" },
                  { v: "prophetes", label: l === "fr" ? "Prophètes" : l === "ht" ? "Pwofèt yo" : l === "es" ? "Profetas" : "Prophets" },
                  { v: "personnages", label: l === "fr" ? "Personnages" : l === "ht" ? "Pèsonaj yo" : l === "es" ? "Personajes" : "Characters" },
                  { v: "priere", label: l === "fr" ? "Prière & Foi" : l === "ht" ? "Lapriyè & Lafwa" : l === "es" ? "Oración & Fe" : "Prayer & Faith" },
                  { v: "sagesse", label: l === "fr" ? "Sagesse & Proverbes" : l === "ht" ? "Sajès & Pwovèb" : l === "es" ? "Sabiduría" : "Wisdom" },
                ].map(({ v, label }) => (
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {[
                  { v: "class",    label: l === "fr" ? "Mon groupe" : l === "ht" ? "Gwoup mwen" : l === "es" ? "Mi grupo" : "My group" },
                  { v: "school",   label: l === "fr" ? "Mon église" : l === "ht" ? "Legliz mwen" : l === "es" ? "Mi iglesia" : "My church" },
                  { v: "national", label: l === "fr" ? "National" : l === "ht" ? "Nasyonal" : l === "es" ? "Nacional" : "National" },
                  { v: "world",    label: l === "fr" ? "Mondial" : l === "ht" ? "Mondyal" : l === "es" ? "Mundial" : "World" },
                ].map(({ v, label }) => (
                  <button key={v} type="button" onClick={() => setScope(v)}
                    className="px-3 py-2 rounded-xl text-xs font-bold transition-all"
                    style={{
                      background: scope === v ? "rgba(74,222,128,0.12)" : "rgba(255,255,255,0.05)",
                      border: scope === v ? "1px solid rgba(74,222,128,0.35)" : "1px solid rgba(255,255,255,0.10)",
                      color: scope === v ? "#4ade80" : "rgba(255,255,255,0.55)",
                    }}>
                    {label}
                  </button>
                ))}
                    ...
                    {q.options_fr.map((opt, oi) => (
                      <div key={oi} className="relative">
                        <input
                          ...
                          style={{
                            ...INPUT,
                            borderColor: q.correct_answer === oi ? "rgba(34,197,94,0.50)" : "rgba(255,255,255,0.12)",
                            background: q.correct_answer === oi ? "rgba(34,197,94,0.08)" : "rgba(255,255,255,0.06)",
                          }}
                        />
                        <button
